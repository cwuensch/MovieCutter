...
struct fsck_message msg_defs[fsck_highest_msgid_defined+1] = {
  ...
  /* 597 */ { mc_FIXEDNBLOCKSVALUE,  "[MC2] %lu: inode has been successfully fixed.", fsck_quiet},
  /* 598 */ { mc_ERRORFIXINGNBLOCKS, "[MC3] %lu: Error fixing nblocks value (return code %d).", fsck_quiet},
