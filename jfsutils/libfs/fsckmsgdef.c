...
struct fsck_message msg_defs[fsck_highest_msgid_defined+1] = {
  ...
  /* 595 */ { mc_FINISHED,              "**Finished.", fsck_quiet},
  /* 596 */ { mc_WRONGNBLOCKSVALUE,     "[MC1] %lu: inode has incorrect nblocks value (nblocks=%lld, real=%lld, size=%lld).", fsck_quiet},
  /* 597 */ { mc_FIXEDNBLOCKSVALUE,     "[MC2] %lu: inode has been marked for correction.", fsck_quiet},
  /* 598 */ { mc_ERRORFIXINGNBLOCKS,    "[MC3] %lu: Error marking the inode for correction.", fsck_quiet},
  /* 599 */ { mc_SUMMARYFIXEDFILES,     "[MC4] %d of %d files successfully fixed.", fsck_quiet},
};
