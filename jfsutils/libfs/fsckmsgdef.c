...
struct fsck_message msg_defs[fsck_highest_msgid_defined+1] = {
  ...
  /* 596 */ { mc_WRONGNBLOCKSVALUE,  "[MC1] %u: inode has incorrect nblocks value (nblocks=%lld, real=%lld).", fsck_quiet},
  /* 597 */ { mc_FIXEDNBLOCKSVALUE,  "[MC2] %u: inode has been successfully fixed.", fsck_quiet},
  /* 598 */ { mc_ERRORFIXINGNBLOCKS, "[MC3] %u: Error fixing nblocks value (return code %d).", fsck_quiet},
