...
struct fsck_message msg_defs[fsck_highest_msgid_defined+1] = {
  ...
  /*  79 */ { fsck_INOPATHOK, "[MC4] File system object %s%s%u is linked as: %s", fsck_quiet},
...
//  /* 590 */ { avail_for_debug_only_590, "*undefined*", fsck_debug},
  /* 590 */ { mc_FINISHED,              "**Finished.", fsck_quiet},
  /* 591 */ { mc_CHECKABORTED,          "MC corrupted inodes have been found. Would be released. -> Check aborted!", fsck_quiet},
  /* 592 */ { mc_PHASEi,                "**Phase i - correction of wrong inode values\n", fsck_quiet},
  /* 593 */ { mc_DEFECTFILEFOUND,       "[MC1] %lu: inode is incorrect (nblocks=%lld, real=%lld, size=%lld).", fsck_quiet},
  /* 594 */ { mc_DEFECTTREEFOUND,       "[MC1] %lu: inode tree error (offset=%lld, first child=%lld).", fsck_quiet},
